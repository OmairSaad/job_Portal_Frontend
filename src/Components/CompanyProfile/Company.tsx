    ...
    return (
        <div className="w-3/4">
            <div className="relative">
                ...
                <img src="/assets/companies/netflix.png" alt="avatar" className=" w-20 h-20 rounded-3xl -bottom-1/4 left-5 absolute border-mine-shaft-900 border-8 bg-mine-shaft-950" />
            </div>
